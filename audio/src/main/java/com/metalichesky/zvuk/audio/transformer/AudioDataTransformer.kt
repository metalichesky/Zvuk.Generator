package com.metalichesky.zvuk.audio.transformer

import com.metalichesky.zvuk.audio.AudioParams
import com.metalichesky.zvuk.audio.math.ComplexNumber
import com.metalichesky.zvuk.audio.math.MathUtil
import com.metalichesky.zvuk.audio.math.clamp
        ...
        return when (byteRate) {
            ...
            2 -> {
                ...
                (value.toByte().toUByte()
                    .toShort() - audioParams.samplesAmplitude.toInt().toShort()).toShort()
            }
        }
    }
